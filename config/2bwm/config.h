 ...
 *6)emptycol         */
static const char *colors[] = {"#46443A","#090100","#D37975","#E8EAEC","#F7B675","#24211A","#090100"};
/*
...
///--Menus and Programs---///
static const char *menucmd[]   = { "dmenu_run", "-i", "-p", ">", "-fn", "Tewi", "-nb", "#090100", "-nf", "#46443A", "-sb", "#46443A", "-sf", "#090100", "-h", "14", NULL };
